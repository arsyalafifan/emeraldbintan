                                        ...
                                        <tbody>
                                            @forelse ($taxi as $t)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a
                                                            href="https://wa.me/628136814512?text={{ urlencode(
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up">
                    <div class="rental-card">
                        ...
                        <div class="rental-body">
                            ...
                            <a href="https://wa.me/628136814512?text={{ urlencode('Hi, I want to rent '.$car->type) }}"
                            target="_blank"
                            class="btn btn-book">
                                {{ tr('Book Now') }}
                            </a>
    ...
    <div class="container">
        ...
        <div class="row mt-5" data-aos="fade-up">
            <div class="col-12 text-center">
                ...
                <div class="mt-4">
                    <a href="https://wa.me/628136814512?text={{ urlencode(tr('Hi, I want to book a tour')) }}" class="btn btn-primary-custom px-4 shadow">{{ tr('Hubungi Tim Kami') }}</a>
                </div>
            </div>
        </div>
